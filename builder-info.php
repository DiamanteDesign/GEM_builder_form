...
<?php
    function showOptionsDrop($builder_state_arr){
        $string = '';
        foreach($builder_state_arr as $k => $v){
...
<p>&nbsp;</p>
<blockquote>
  <h1 id="Title" p style="text-align:center;">Preferred Builder Questionnairre</p></h1>
</blockquote>
<form name="builder_form_1" action="#" method="post">
<table width="92%" border="0" cellpadding="3">
    <tbody>
      <tr>
        <th colspan="12" align="left" bgcolor="#33CCFF" scope="col"><h3>I. General Information</h3></th>
      </tr>
      <tr>
        <th width="8%" align="right" scope="col"><label for="" id="builder_name">Company Name:</label></th>
        <th colspan="11" align="left" scope="col"><input name="builder_name" type="text" required id="builder_name" form="builder_form_1" size="35" maxlength="90">
        </th>
      </tr>
      <tr>
        <td align="right"><strong id="builder_type">Company Type:</strong></td>
        <td colspan="11" align="left"><p>
          <label>
      ...
      <tr>
        ...
        <td width="4%" align="right"><strong id="builder_address_2">Suite:</strong></td>
        <td colspan="2" align="left"><input name="builder_address_2" type="text" id="builder_address_3" size="25"></td>
        <td width="11%" align="right"><label for="builder_city"><strong id="builder_city">City:</strong></label></td>
        <td width="12%" align="left"><input type="text" name="builder_city" id="builder_city2"></td>
        
        
       <td width="4%" align="right" id="builder_state"><strong id="builder_state">State:</strong></td>
        
        
        <td width="11%" align="left">
    <select name="builder_state" option value="0"></option>
...
<!--        <td align="left" id="builder_state"><input name="builder_state" type="text" id="builder_state" size="2"></td> -->
        ...
        <td width="2%" align="right" nowrap><label for="builder_zip"><strong id="builder_zip">Zip</strong>:</label></td>
        <td width="7%" align="left"><input name="builder_zip" type="text" id="builder_zip" size="9"></td>
      </tr>
      <tr>
        ...
        <td colspan="11" align="left"><input name="builder_principal_officer" type="text" required id="builder_principal_officer" size="35"></td>
      </tr>
      <tr>
        <td align="right"><label for="builder_business_phone"><strong id="builder_business_phone">Business Phone:</strong></label></td>
        <td colspan="11" align="left"><input name="builder_business_phone" type="tel" required id="builder_business_phone" size="35"></td>
      </tr>
      <tr>
        <td align="right"><label for="builder_cell_phone"><strong id="builder_cell_phone">Cell Phone:</strong></label></td>
        <td colspan="11" align="left"><input name="builder_cell_phone" type="tel" id="builder_cell_phone" size="35"></td>
      </tr>
      <tr>
        <td align="right"><label for="builder_fax"><strong id="builder_fax">Fax:</strong></label></td>
        <td colspan="11" align="left"><input name="builder_fax" type="tel" id="builder_fax" size="35"></td>
      </tr>
      <tr>
        <td align="right"><label for="builder_email"><strong id="builder_email">Email:</strong></label></td>
        <td colspan="11" align="left"><input name="builder_email" type="builder_email" id="builder_email" size="35"></td>
      </tr>
      <tr>
        <td align="right"><label for="builder_url"><strong id="url">Web Page URL:</strong></label></td>
        <td colspan="11" align="left"><input name="builder_url" type="builder_url" id="builder_url" title="builder_url" size="35"></td>
      </tr>
      <tr>
        <td colspan="12" align="left" valign="baseline" bgcolor="#33CCFF"><h3><strong>II. Green Building Certifications - Experience</strong></h3></td>
      </tr>
      <tr>
...
Current Highest HERS Index Achieved </strong>:</td>
      ...
      <tr>
        ...
        <td colspan="3" align="center"><strong id="builder_custom">Are you a Custom Builder?</strong></td>
      ...
      <tr>
        ...
        <td colspan="3" align="right"><strong id="builder_avg_sales_price">Average Sales or Construction Price:          </strong></td>
      ...
      <tr>
        ...
        <td colspan="11" align="left"><textarea name="textarea" cols="35" rows="5" id="textarea"></textarea></td>
      </tr>
      <tr>
        <td colspan="6" align="center"><h4 id="builder_info_green_lender">Would you like more information about our Green Lender and Appraisal Platform?</strong><br>
        </h4></td>
        <td align="left"><label>
          <input type="radio" name="builder_info_green_lender" value=" yes" id="builder_info_green_lender2">
          Yes</label>
          <br>
          <label>
            <input type="radio" name="builder_info_green_lender" value="no" id="builder_info_green_lender2">
        No</label></td>
        <td colspan="2" align="left">&nbsp;</td>
      </tr>
      <tr bgcolor="#33CCFF">
        <td colspan="12" align="left"><h3> III. What are your current Green Building-Financing Constraints and Challenges?</h3></td>
      </tr>
      <tr>
        <td align="right" valign="middle" id="builder_challenges"><h4 id="builder_challenges">Select All that Apply:</h4></td>
        <td colspan="11" align="left"><p>
          <label>
      ...
      <tr>
        <td align="right" valign="middle" id="builder_challenges3"><p><strong>Access to Green:</strong></p>
        <h4></h4></td>
        <td colspan="11" align="left"><label>
      ...
      <tr>
        <td align="right" valign="middle" id="builder_challenges2">Capitalization:</td>
        <td colspan="11" align="left"><label>
          <input type="checkbox" name="builder_challenges_3" value="equity partners" id="builder_challenges_">
          Identifying equity partners</label>
          <br>
          <label>
            <input type="checkbox" name="builder_challenges_3" value="warehouse line" id="builder_challenges_">
            Production warehouse line</label>
          <br>
          <label>
            <input type="checkbox" name="builder_challenges_3" value="construction loan" id="builder_challenges_">
        Construction loans</label></td>
      </tr>
      <tr bgcolor="#33CCFF">
        <td colspan="12" align="left"><h3 id="company experience">IV.  Company and Owner Experience</h3></td>
      </tr>
      <tr>
        <td align="left">&nbsp;</td>
        <td colspan="4" align="left"><strong id="builder_year_in_business2">How many years have you been in the Building Industry?</strong></td>
        <td colspan="7" align="left"><input name="builder_year_in_business" type="text" id="builder_year_in_business" size="10"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="3" align="right" id="builder_num_subcontractors"><strong id="builder_num_subcontractors">Number of Sub Contractors:</strong></td>
      ...
      <tr>
        ...
        <td width="4%" align="left"><strong id="builder_presales">Pre Sales:</strong></td>
        <td width="16%" align="left"><input name="builder_presales" type="text" id="presales3" size="15"></td>
        <td align="right"><strong id="builder_specs">Specs:</strong></td>
        <td colspan="2" align="left"><input name="builder_specs" type="text" id="specs9" size="15"></td>
        <td align="left"><strong id="builder_devel_projects2">Development Projects:</strong></td>
        <td align="left"><input name="builder_devel_projects" type="text" id="builder_devel_projects" size="15"></td>
        <td colspan="2" align="right">&nbsp;</td>
        <td colspan="2" align="left">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" id="builder_gem_preferred"><h3 id="builder_gem_preferred">&nbsp;</h3></td>
        <td colspan="5" align="left"><h3 id="builder_gem_preferred">Would you like to become a GEM Preferred Builder?<br>
        </h3></td>
        <td align="left"><label>
          <input type="radio" name="builder_gem_preferred" value="Yes" id="builder_gem_preferred2">
          Yes</label>
          <br>
          <label id="builder_gem_preferred">
            <input type="radio" name="builder_gem_preferred" value="no" id="builder_gem_preferred2">
        No</label></td>
        <td align="left">&nbsp;</td>
        <td colspan="2" align="left">&nbsp;</td>
        <td colspan="2" align="left">&nbsp;</td>
      ...
      <tr>
        <td align="right" id="builder_optional">&nbsp;</td>
        <td colspan="11" align="left"><p>The builder, as an individual and/or officer of the building company, hereby authorizes Green Energy Money to make any normal inquiries necessary to qualify the builder for its’ Preferred Builder program.  It is understood that any inquiry or satisfactory review is not intended to constitute an approval for lending purposes.  The undersigned hereby certifies he/she is authorized to do business in the company’s name.</p></td>
      </tr>
      <tr>
        ...
        <td colspan="2" align="right"><strong>
          <input type="sig_date" name="sig_date" id="sig_date">
        </strong></td>
        <td colspan="2" align="left"><label for="sig_date"></label></td>
      </tr>
    </tbody>
  </table>
</form>
